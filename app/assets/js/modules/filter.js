...
export class Filter {
    ...
    init() {
        let w = false,
            ...
            createSlides = (element, param, frac, trigger, classCopy = "", wrap = "", triggerBigCard = false) => {
                ...
                if (triggerBigCard) {
                    ...
                    cardFront.style.backgroundImage = this.dbFractionlocal[frac][param];
                    cardBack.style.backgroundImage = this.dbFractionlocal[frac][param];
                    ...
                    element.style.backgroundImage = this.dbFractionlocal[frac][param];
                    element.dataset.fraction = frac;
                    if (trigger) {
