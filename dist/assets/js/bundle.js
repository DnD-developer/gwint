...
/* harmony export */ });
/* harmony import */ var _services_services__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../services/services */ "./app/assets/js/services/services.js");


class Filter {
  constructor(db, dblocal) {
    this.dbFraction = db;
  ...
  init() {
    ...
    let w = false,
        createSlides = function (element, param, frac, trigger) {
      let classCopy = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : "";
      let wrap = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : "";
      let triggerBigCard = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : false;
      ...
      if (triggerBigCard) {
        ...
        cardFront.style.backgroundImage = _this.dbFractionlocal[frac][param];
        cardBack.style.backgroundImage = _this.dbFractionlocal[frac][param];
        element.dataset.fraction = frac;
        ...
        element.style.backgroundImage = _this.dbFractionlocal[frac][param];
        element.dataset.fraction = frac;

        if (trigger) {
          element.classList.add(classCopy);
          element.classList.add("swiper-slide");
          document.querySelector(`${wrap} .swiper-wrapper`).appendChild(element);
        }
      }
    ...
    for (let frac in this.dbFractionlocal) {
      if (!w) {
        createSlides(document.querySelector(".wrapper-copy"), "bg", frac, w);
        createSlides(document.querySelector(".slider-fraction-copy"), "logo", frac, w);
        createSlides(document.querySelector(".random-cards__bigcard-slider .swiper-slide"), "bgBack", frac, w, "", "", true);
        w = true;
      } else {
        ...
        createSlides(wrapperBgCopy, "bg", frac, w, "wrapper-copy", ".wrapper-slider");
        createSlides(logoBgCopy, "logo", frac, w, "slider-fraction-copy", ".slider-logo");
        createSlides(bigCardBgCopy, "bgBack", frac, w, "", ".random-cards__bigcard-slider", true);
      }
    }

    (0,_services_services__WEBPACK_IMPORTED_MODULE_0__.changeCards)(".cards", ".card-item__front", ".card-item__back");
  }
      ...
      for (let group in this.dbFraction[fraction]) {
        if (this.dbFraction[fraction][group][totalFreeCard[randomCard]]) {
          ...
          if ('ontouchstart' in window) {
            ...
            document.querySelector(".random-cards__bigcard-slider .swiper-slide-active .random-cards__bigcard-back").addEventListener("mouseout", () => {
              zeroCSS();
            }, 1);
          }
  ...
  moveCard() {
    ...
    let changeGamersCard = (e, nameCardsContent, gamerTrigger) => {
      if (e.target && (e.target.classList.contains("move-card-svg") || e.target.closest(".move-card-svg"))) {
        ...
        this.renderCard(document.querySelector(`.all-cards__tabs-trigger li.active-tab`));
        this.renderCard(document.querySelector(`.deck-cards__tabs-trigger li.active-tab`));
        (0,_services_services__WEBPACK_IMPORTED_MODULE_0__.putDbFraction)("http://localhost:3000/dbCards", JSON.parse(JSON.stringify(this.dbFraction))).finally(() => preloader.style.display = "none");
      }
    };
...
function scroll() {
  new simplebar__WEBPACK_IMPORTED_MODULE_0__["default"](document.querySelector(".all-cards__content"), {
    autoHide: false,
    scrollbarMaxSize: 45
  });
  new simplebar__WEBPACK_IMPORTED_MODULE_0__["default"](document.querySelector(".deck-cards__content"), {
    autoHide: false,
    scrollbarMaxSize: 45
  });
}
...
/***/ "./app/assets/js/modules/sliders.js":
/*!******************************************!*\
  !*** ./app/assets/js/modules/sliders.js ***!
  \******************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
function sliders() {
  ...
  const swiperFractionBg = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".wrapper-slider", {
    loop: true,
    effect: 'fade',
    fadeEffect: {
      crossFade: true
  ...
  const swiperBigCardBg = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".random-cards__bigcard-slider ", {
    loop: true,
    effect: 'fade',
    fadeEffect: {
      crossFade: true
  ...
  const swiperFraction = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".slider-fraction", {
    loop: true,
    slidesPerView: 3,
    centeredSlides: true,
    speed: 500,
...
/***/ "./app/assets/js/modules/tabsCategoriesCard.js":
/*!*****************************************************!*\
  !*** ./app/assets/js/modules/tabsCategoriesCard.js ***!
  \*****************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "tabsCategoriesCard": function() { return /* binding */ tabsCategoriesCard; }
/* harmony export */ });
function tabsCategoriesCard(triggers, contents, filter) {
...
/* harmony export */   "parseDbFraction": function() { return /* binding */ parseDbFraction; },
/* harmony export */   "putDbFraction": function() { return /* binding */ putDbFraction; },
/* harmony export */   "zeroFilter": function() { return /* binding */ zeroFilter; },
/* harmony export */   "filter": function() { return /* binding */ filter; },
/* harmony export */   "dbFractions": function() { return /* binding */ dbFractions; },
/* harmony export */   "dbCards": function() { return /* binding */ dbCards; }
/* harmony export */ });
/* harmony import */ var _modules_tabsCategoriesCard__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../modules/tabsCategoriesCard */ "./app/assets/js/modules/tabsCategoriesCard.js");
...
function zeroFilter() {
  (0,_modules_tabsCategoriesCard__WEBPACK_IMPORTED_MODULE_0__.tabsCategoriesCard)(".all-cards__tabs-trigger li", ".all-cards__tabs-content h4", filter.class);
  (0,_modules_tabsCategoriesCard__WEBPACK_IMPORTED_MODULE_0__.tabsCategoriesCard)(".deck-cards__tabs-trigger li", ".deck-cards__tabs-content h4", filter.class);
...
/* harmony import */ var _services_services__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./services/services */ "./app/assets/js/services/services.js");
/* harmony import */ var _modules_scroll__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/scroll */ "./app/assets/js/modules/scroll.js");
/* harmony import */ var _modules_filter__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/filter */ "./app/assets/js/modules/filter.js");
...
document.addEventListener('DOMContentLoaded', () => {
  const preloader = document.querySelector(".popup-preloader");
  preloader.style.display = "flex";
  (0,_services_services__WEBPACK_IMPORTED_MODULE_1__.init)();
  (0,_modules_scroll__WEBPACK_IMPORTED_MODULE_2__.scroll)();
  (0,_services_services__WEBPACK_IMPORTED_MODULE_1__.parseDbFraction)("http://localhost:3000/dbFraction").then(frac => {
    _services_services__WEBPACK_IMPORTED_MODULE_1__.dbFractions.db = JSON.parse(JSON.stringify(frac));
  }).then(() => {
    (0,_services_services__WEBPACK_IMPORTED_MODULE_1__.parseDbFraction)("http://localhost:3000/dbCards").then(card => {
      _services_services__WEBPACK_IMPORTED_MODULE_1__.dbCards.db = JSON.parse(JSON.stringify(card));
      _services_services__WEBPACK_IMPORTED_MODULE_1__.filter["class"] = new _modules_filter__WEBPACK_IMPORTED_MODULE_3__.Filter(_services_services__WEBPACK_IMPORTED_MODULE_1__.dbCards.db, _services_services__WEBPACK_IMPORTED_MODULE_1__.dbFractions.db);
      _services_services__WEBPACK_IMPORTED_MODULE_1__.filter["class"].init();
      (0,_modules_sliders_js__WEBPACK_IMPORTED_MODULE_0__.sliders)();
      _services_services__WEBPACK_IMPORTED_MODULE_1__.filter["class"].moveCard();
      (0,_services_services__WEBPACK_IMPORTED_MODULE_1__.zeroFilter)();
    });
  }).finally(() => preloader.style.display = "none");
  document.querySelector(".random-cards__bigcard-btn").addEventListener("click", () => {
    preloader.style.display = "flex";
    _services_services__WEBPACK_IMPORTED_MODULE_1__.filter["class"].randomaizer();
    (0,_services_services__WEBPACK_IMPORTED_MODULE_1__.putDbFraction)("http://localhost:3000/dbCards", JSON.parse(JSON.stringify(_services_services__WEBPACK_IMPORTED_MODULE_1__.dbCards.db))).finally(() => preloader.style.display = "none");
  });
});
}();
/******/ })()
