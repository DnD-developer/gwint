...
/* harmony export */ });
/* harmony import */ var _filter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./filter */ "./app/assets/js/modules/filter.js");
...
const filter = new _filter__WEBPACK_IMPORTED_MODULE_0__.Filter(dbFraction(), dbFractionLocal());
...
/* harmony export */ });
/* harmony import */ var _db__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./db */ "./app/assets/js/modules/db.js");

function tabsCategoriesCard(triggers, contents) {
  ...
  tabsTriggersDomElements.forEach((el, i) => {
    el.addEventListener("click", e => {
      hiddenAll();
      showCurrent(i);
      _db__WEBPACK_IMPORTED_MODULE_0__.filter.renderCard(el);
    });
  });
  hiddenAll();
  showCurrent(0);
